...
public abstract interface ApproveServiceIface<T, PK extends Serializable>
{
  ...
  public abstract T approve(T paramT);

  public abstract T deploy(T paramT);
 ...
 * Qualified Name:     com.smarthome.imcp.service.ApproveServiceIface
