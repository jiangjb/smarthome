...
<body>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							<span>
								<input type="hidden" name="deviceCode0" id="deviceCode0"  value="" />
							</span>
						</div>
					</div>
				</div>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							<span>
								<input type="hidden" name="type0" id="type0"  value="" />
							</span>
						</div>
					</div>
				</div>
	...
	//取消
    function excel(){
    	$('#deviceCode').val($('#deviceCode0').val());
    	$('#type').val($('#type0').val());
    	$("#deviceCode").focus();
    }
	//客户端校验
	...
	function modify(){
		...
		/* debugger */
			...
			var deviceCode0=$("#deviceCode0").val();
			var type=$("#type").val();
			var type0=$("#type0").val();
			if(deviceCode !=deviceCode0 || type !=type0){
				$.ajax({
					url:"${pageContext.request.contextPath}/modifyHostDevice.do",
